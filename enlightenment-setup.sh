...
sudo pacman -S alsa-plugins asunder baobab brasero dosfstools ffmpeg file-roller gnome-disk-utility hplip libdvdcss libreoffice-calc libreoffice-impress libreoffice-writer lxappearance-obconf lxrandr mumble ntfs-3g speex steam system-config-printer transmission-gtk unrar unzip vlc vorbis-tools
