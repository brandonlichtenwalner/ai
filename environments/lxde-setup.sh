...
pacman -S cairo-dock gnome-icon-theme-extras gvfs lxde xcompmgr
...
echo '@cairo-dock -c -f' >> /home/$USER1/.config/lxsession/LXDE/autostart
...
if [ "$USER2" != "" ]; then
  ...
  echo '@cairo-dock -c -f' >> /home/$USER2/.config/lxsession/LXDE/autostart
fi
